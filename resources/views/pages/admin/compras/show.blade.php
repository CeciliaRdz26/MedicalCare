            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4">
                        ...
                        <x-input id="cantidad" class="block mt-1 w-full" type="number" step="1" name="cantidad" :value="old('cantidad', $compra->cantidad)"  disabled />
                        <x-individual-input-error  :messages="$errors->get('cantidad')" class="mt-2" />
                    </div>

                    <div class="mb-4">
                        <x-label for="precio" :value="__('Precio')" />
                        <x-input id="precio" class="block mt-1 w-full" type="number" step="1" name="precio" :value="old('precio', $compra->precio)"  disabled />
                    ...
                    <div class="mb-4">
                        ...
                        <x-input id="descuento" class="block mt-1 w-full" type="number" step="0.01" name="descuento" :value="old('descuento', $compra->descuento)"  disabled />
                        <x-individual-input-error  :messages="$errors->get('descuento')" class="mt-2" />
                    </div>

                    <div class="mb-4">
                        <x-label for="total" :value="__('Total')" />
                        <x-input id="total" class="block mt-1 w-full" type="number" step="1" name="total" :value="old('total', $compra->total)"  disabled />
                        <x-individual-input-error  :messages="$errors->get('total')" class="mt-2" />
                    </div>
