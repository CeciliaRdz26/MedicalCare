            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4">
                        ...
                        <x-individual-input-error  :messages="$errors->get('fecha_entrada')" class="mt-2" />
                    </div>
                    <div class="mb-4">
                        ...
                        <x-individual-input-error  :messages="$errors->get('fecha_salida')" class="mt-2" />
                    </div>
                    <div class="mb-4">
                        <x-label for="movimiento" :value="__('Movimiento')" />
                        ...
                        <x-individual-input-error  :messages="$errors->get('movimiento')" class="mt-2" />
                    </div>
                    <div class="mb-4">
                        <x-label for="motivo" :value="__('Motivo')" />
                        <x-input id="motivo" class="block mt-1 w-full" type="text" name="motivo" :value="old('motivo', $inventario->motivo)"  disabled />
                        <x-individual-input-error  :messages="$errors->get('motivo')" class="mt-2" />
                    </div>
                    <div class="mb-4">
                        <x-label for="cantidad" :value="__('Cantidad')" />
                        <x-input id="cantidad" class="block mt-1 w-full" type="number" step="1" name="cantidad" :value="old('cantidad', $inventario->cantidad)"  disabled />
